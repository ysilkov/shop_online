...
const Settings = () =>{
   const {email, fullName, id, phone, address, message} = useAppSelector((state)=>state.auth)
  ...
  const [delivery, setDelivery] = useState(false)
   ...
   return (
      ...
      <div className={style.settings_block}>
        ...
        <form onSubmit={sendProfile} className={profile ? style.profile_active : style.profile_hidden}>
          <label>
          ...
          <div className={style.settings_delivery_form}>
            <section>
            <button onClick={()=>setDelivery(!delivery)}>Delivery data</button>
            </section>
          <form onSubmit={sendDelivery}  className={delivery? style.delivery_active : style.delivery_hidden}>
          <label>
            <p>Your phone: </p>
            <input
              type="tel"
